var definitions = {
    ...
    "Column family": "A database object that contains columns of related data.",
    ...
    "DOM": "The Document Object Model (DOM) is a programming interface for HTML and XML documents. It represents the page so that programs can change the document structure, style, and content. The DOM represents the document as nodes and objects.",
    ...
    "Nginx": "Nginx ( /ˌɛndʒɪnˈɛks/ EN-jin-EKS[8]) (stylized as NGINX, NGiИX or nginx) is a web server which can also be used as a reverse proxy, load balancer, mail proxy and HTTP cache.",
    ...
    "Responsive Design": "Websites that change to the size of the screen on which they're being viewed.",
